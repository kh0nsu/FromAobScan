    ...
    class Program
    {
        ...
        public void run(string exe, string testAob = null)
        {
            ...
            Action doERScan = () =>
            {
                ...
                findAddr(textSection, header.VirtualAddress, "803D ???????? 00 74 1f ba 05000000", "groupMask",  2, 7, startIndex: 6000000); //may not be exactly group mask if they change it between patches. look around here for 01010101... in memory
                ...
                findAddr(textSection, header.VirtualAddress, "48 8B 0D ?? ?? ?? ?? 83 79 ?? 00 0F 85 ?? ?? ?? ?? 49 8B 87 ?? ?? ?? ?? 48 8B 88 ?? ?? ?? ?? E8", "newMenuSystem", 3, 7, startIndex: 5000000); //TODO: consider fixing for older patches
