    ...
    class Program
    {
        ...
        public void run(string exe)
        {
            ...
            Action doDS3Scan = () =>
            {
                ...
                findAddr(textSection, header.VirtualAddress, "48 8B0D ???????? 48 85C9 74 1A 4C 8D4B 30 4C 8D43 20 48 8D53 14 C64424 20 01 E8 ????????", "NS_SPRJ::FieldArea", 3, 3 + 4);
                findAddr(textSection, header.VirtualAddress, "48 8B05 ???????? 48 8B88 ???? 0000 E9 ???????? 48 8B5C24 30 83C8 FF E9 ????????", "NS_SPRJ::FrpgNetManImp / BaseEOff", 3, 3 + 4);
                ...
                findAddr(textSection, header.VirtualAddress, "48 833D ???????? 00 75 30 4C 894424 48 BA 08000000 B9 D01B0000 E8 ????????", "NS_SPRJ::SoloParamRepositoryImp", 3, 3 + 4 + 1);
